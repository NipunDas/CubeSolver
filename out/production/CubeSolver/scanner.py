...
test_output = subprocess.check_output('java ProcessString ' + color_data, stderr=subprocess.PIPE)
...
url += '&setup=%2F%2FIgnore_Setup_%26%2345%3B_Solving_Instructions_in_-Moves-_Section%0A'
