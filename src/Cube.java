...
public class Cube {
    ...
    public void setColors(String colors) {
        ...
        edges[1].setC2(colors.charAt(28));
        ...
        //side 6 (yellow)
        corners[4].setC1(colors.charAt(45));
        edges[4].setC1(colors.charAt(46));
        corners[5].setC1(colors.charAt(47));
        edges[7].setC1(colors.charAt(48));
        edges[5].setC1(colors.charAt(50));
        corners[7].setC1(colors.charAt(51));
        edges[6].setC1(colors.charAt(52));
        corners[6].setC1(colors.charAt(53));
    }
    ...
    public String invertSolution() {
        ...
        inverse = inverse.substring(0, solution.length()-1);
        return inverse;
    }
}
